...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	elseif ($_GET['module'] == 'form_paciente') {
		include "modules/paciente/form.php";
	}

	
	elseif ($_GET['module'] == 'especialidades') {
		include "modules/especialidades/view.php";
	}

	elseif ($_GET['module'] == 'form_especialidades') {
		include "modules/especialidades/form.php";
	}
