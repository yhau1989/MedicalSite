      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Bienvenido <strong><?php echo $_SESSION['name_user']; ?></strong> a la aplicación de control de medicamentos.
          </p>        
        </div>
      </div>  
    </div>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            $query = mysqli_query($mysqli, "SELECT COUNT(codigo) as numero FROM pacientes")
          ...
          if ($_SESSION['permisos_acceso']!='gerente') { ?>
            <a href="?module=form_paciente&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
