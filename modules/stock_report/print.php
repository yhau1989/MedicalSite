...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.tipo_transaccion, a.codigo_transaccion,a.fecha,a.codigo,a.numero,b.codigo,b.nombre,b.unidad, CONCAT (pac.nombres,' ' ,pac.apellidos) as paciente , a.comentario
                                    FROM transaccion_medicamentos as a 
                                    INNER JOIN medicamentos as b ON a.codigo=b.codigo
                                    LEFT JOIN pacientes as pac on a.id_paciente = pac.id
                                    WHERE a.fecha BETWEEN '$tgl1'  AND '$tgl2' 
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle"><small>PACIENTE</small></th>
                        <th height="20" align="center" valign="middle"><small>COMENTARIO</small></th>
                    </tr>
                </thead>
                <tbody>
<?php
    ...
    if($count == 0) {
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[paciente]</td>
                        <td width='120' height='13' align='left' valign='middle'>$data[comentario]</td>
                    </tr>";
            $no++;
        }
    }
