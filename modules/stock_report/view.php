        ...
        <form role="form" class="form-horizontal" method="GET" action="modules/stock_report/print.php" target="_blank">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="date" name="tgl_awal" class="form-control" autocomplete="off" required>
              </div>

              <label class="col-sm-1">Hasta</label>
              <div class="col-sm-2">
                <input style="margin-left:-35px" type="date" class="form-control" name="tgl_akhir" autocomplete="off" required>
              </div>
            </div>
          </div>
