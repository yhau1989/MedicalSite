          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td width='120' class='center' width='100'>
                          <div>";
            ...
            <?php
              ...
              echo "      <a data-toggle='tooltip' data-placement='top' title='Modificar' style='margin-right:6px' class='btn btn-primary btn-sm' href='?module=form_user&form=edit&id=$data[id_user]'>
                                <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                            </a>
                            <a data-toggle='tooltip' data-placement='top' title='Eliminar' class='btn btn-danger btn-sm' href='modules/user/proses.php?act=del&id=$data[id_user]'>
                                <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                            </a>
