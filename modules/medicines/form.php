        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/medicines/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Cantidad Ingresada</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Cantidad consumida</label>
                <div class="col-sm-5">
                  <div class="input-group">
                    <span class="input-group-addon"></span>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    <span class="input-group-addon"></span>
                    <input type="text" class="form-control" id="stock" name="stock" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
                  </div>
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label">Unidad de Medidas</label>
                <div class="col-sm-5">
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT codigo,nombre,precio_compra,precio_venta,unidad,stock FROM medicamentos WHERE codigo='$_GET[id]'") 
                                      or die('error: '.mysqli_error($mysqli));
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    <span class="input-group-addon"></span>
                    <input type="text" class="form-control" id="stock" name="stock" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo format_rupiah($data['stock']); ?>" required>
                  </div>
                </div>
              </div>
