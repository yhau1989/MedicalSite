...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Control de Medicamentos</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Control de Medicamentos">
    <meta name="author" content="Control de Medicamentos - Control Web" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:20px">CONTROL MEDICO</span>
        </a>
