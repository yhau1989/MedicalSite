...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  ...
  <?php
   ...
   if ($_GET["module"]=="paciente" || $_GET["module"]=="form_paciente") { ?>
    <li class="active">
      <a href="?module=paciente"><i class="fa fa-folder"></i> Datos de Paciente </a>
      </li>
  <?php
  }
  ...
  <?php
   ...
   if ($_GET["module"]=="medicos" || $_GET["module"]=="form_medicos") { ?>
    <li class="active">
      <a href="?module=medicos"><i class="fa fa-folder"></i> Datos de Medicos </a>
      </li>
  <?php
  }
  ...
  <?php
   ...
   if ($_GET["module"]=="especialidades" || $_GET["module"]=="form_especialidades") { ?>
    <li class="active">
      <a href="?module=especialidades"><i class="fa fa-folder"></i> Datos de Especialidades </a>
      </li>
  <?php
  }
